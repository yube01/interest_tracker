...
if($bank != "none" || $option == 1){
     if($option == 1){
        $personal = "select * from personal_loan where status in (1,2,3) order by pid desc";
     }else{
        $personal = "select * from personal_loan where name = '$bank' and status in (1,2,3) order by pid desc";
     }
