...
if(isset($_POST['savFix'])){
    ...
    if($result){
        echo "Added";
        header("Location: ../../../home/home.php?msg=$name bank detail added");
    }else{
        echo "Error";
    }
}
...
if(isset($_POST['personal'])){
    ...
    if($result){
        echo "Added";
        header("Location: ../../../loan/loan.php?msg=$name bank detail added");
    }else{
        echo "Error";
    }
}
...
if(isset($_POST['studentLoan'])){
    ...
    if($result){
        echo "Added";
        header("Location: ../../../page/studentLoan.php?msg=$name bank detail added");
    }else{
        echo "Error";
    }
}
...
if(isset($_POST['studentSav'])){
    ...
    if($result){
        echo "Added";
        header("Location: ../../../page/studentSaving.php?msg=$name bank detail added");
    }else{
        echo "Error";
    }
}
